...
namespace POO_Parcial1_Ej2
{
    ...
    {
        /*
        Una Empresa dedicada a la venta de Jugos, desea registrar la información de sus vendedores, respecto a: nombre, zonaDeVenta, totalVendido y comisión.  Donde totalVendido representa las ventas realizadas por el vendedor en cada mes, y comisión un porcentaje que depende del totalVendido.  
        ...
        Si $75.000 <= totalVendido < $100.000, la comisión es del 20%. Si $100.000 <= totalVendido, la comisión es del 30 %. 
